...
<style>
    ...
    /* Nút bấm đồng bộ màu Navy Blue */
    .btn-navy { background-color: #0d1b2a; color: white; border-radius: 0; padding: 10px 30px; }
    .btn-navy:hover { background-color: #1b263b; color: white; }

    /* Style cho danh mục */
    .category-box { padding: 20px; border: 1px solid #eee; transition: 0.3s; border-radius: 10px; }
    .category-box:hover { background: #f8f9fa; cursor: pointer; border-color: #0d1b2a; }
...
<main>
    <div class="container my-5 text-center">
        ...
        <div class="row">
            <div class="col-md-4 mb-3"><div class="category-box"><h5><i class="fas fa-tshirt"></i> Áo Hoodie</h5></div></div>
            <div class="col-md-4 mb-3"><div class="category-box"><h5><i class="fas fa-mitten"></i> Quần Jeans</h5></div></div>
            <div class="col-md-4 mb-3"><div class="category-box"><h5><i class="fas fa-star"></i> Phụ kiện</h5></div></div>
        </div>
    </div>
    ...
    <div class="container mb-5">
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="card product-card">
                    <img src="Views/image/38f822d4-762a-44c9-9612-38359ee6bbd5.jpg" class="card-img-top product-img" alt="Áo">
                    <div class="card-body text-center">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                <div class="p-3 border-start border-4 border-navy bg-light h-100">
                    ...
                    <p class="small text-muted mb-0">"Đơn hàng của Kenzie thường được xử lý và giao đến tay khách hàng trong vòng 2-4 ngày làm việc. Bạn sẽ sớm nhận được mã vận đơn để theo dõi hành trình đơn hàng nhé!"</p>
                </div>
            </div>
            <div class="col-md-6 mb-3">
                <div class="p-3 border-start border-4 border-navy bg-light h-100">
                    <h6><i class="fas fa-undo text-navy"></i> Chính sách đổi trả</h6>
                    <p class="small text-muted mb-0">"Kenzie hỗ trợ đổi size hoặc đổi mẫu trong vòng 30 ngày (sản phẩm còn nguyên tem mác). Nếu hàng lỗi, Kenzie cam kết đổi mới 1-1 và chịu toàn bộ phí ship ạ."</p>
                </div>
            </div>
            <div class="col-md-6 mb-3">
                <div class="p-3 border-start border-4 border-navy bg-light h-100">
                    <h6><i class="fas fa-ruler-combined text-navy"></i> Tư vấn chọn size</h6>
                    <p class="small text-muted mb-0">"Chào bạn, hãy nhắn cho Kenzie chiều cao và cân nặng nhé! Kenzie sẽ tư vấn size vừa vặn nhất với form người của bạn để mặc lên đẹp nhất ạ."</p>
                </div>
            </div>
            <div class="col-md-6 mb-3">
                <div class="p-3 border-start border-4 border-navy bg-light h-100">
                    <h6><i class="fas fa-check-circle text-navy"></i> Cam kết chất lượng</h6>
                    <p class="small text-muted mb-0">"Sản phẩm tại Kenzie luôn đảm bảo vải bền, không xù lông và đúng hình ảnh 100%. Nếu không hài lòng về chất lượng, Kenzie cam kết hỗ trợ hoàn tiền cho bạn."</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <div class="card p-4 h-100 border-0 shadow-sm text-center">
                ...
                <p class="card-text small text-muted">
                    "Hoodie bên shop chất vải dày dặn, mặc lên form cực đẹp luôn. Ship hàng cũng nhanh nữa, sẽ ủng hộ shop dài dài!"
                </p>
        ...
        <div class="col-md-4 mb-3">
            <div class="card p-4 h-100 border-0 shadow-sm text-center">
                ...
                <p class="card-text small text-muted">
                    "Quần Jeans rất ưng ý, vải không bị xù lông sau khi giặt. Shop tư vấn size cực chuẩn, mình mặc vừa vặn không cần sửa lại."
                </p>
        ...
        <div class="col-md-4 mb-3">
            <div class="card p-4 h-100 border-0 shadow-sm text-center">
                ...
                <p class="card-text small text-muted">
                    "Lần đầu mua hàng mà thấy hài lòng quá. Shop hỗ trợ nhiệt tình, đổi trả nhanh chóng. Chất lượng thực tế còn đẹp hơn cả hình!"
                </p>
...
<div class="container my-5">
            ...
            <div class="card border-0 shadow-sm h-100 overflow-hidden">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted small">
                        Những mẫu hoodie local brand đang được giới trẻ yêu thích với thiết kế oversize và tone màu cực trendy.
                    </p>
        ...
        <div class="col-md-4 mb-4">
            <div class="card border-0 shadow-sm h-100 overflow-hidden">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted small">
                        Gợi ý các outfit đơn giản nhưng cực chất giúp bạn phối quần jeans với hoodie và sneaker chuẩn fashion.
                    </p>
    ...
    <div class="card border-0 shadow-sm h-100 overflow-hidden">
        ...
        <div class="card-body">
            ...
            <p class="text-muted small">
                Áo thun form rộng với thiết kế basic đang trở thành xu hướng thời trang được nhiều bạn trẻ yêu thích hiện nay.
            </p>
