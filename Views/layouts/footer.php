<footer class="text-white pt-5 pb-3 mt-5" style="background-color: #0d1b2a;">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                ...
                <ul class="list-unstyled text-secondary">
                    <li class="mb-2"><i class="fas fa-envelope me-2"></i> Kenzie@gmail.com</li>
                    <li class="mb-2"><i class="fas fa-phone me-2"></i> 0329 890 373</li>
                    <li class="mb-2"><i class="fas fa-map-marker-alt me-2"></i> Cần Thơ, Việt Nam</li>
                </ul>
            </div>
        </div>
        ...
        <div class="text-center text-secondary small">
            <p class="mb-0">© 2026 Kenzie Store. Thiết kế bởi đội ngũ Kenzie.</p>
        </div>
    </div>
</footer>
